<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "SELECT * FROM login_twitter WHERE username ='$username'";
        ...
        if($count_user == 0 && $count_email == 0){
            if($password == $cpassword){
                ...
                $sql = "INSERT INTO login_twitter (username, email, password) VALUES ('$username', '$email', '$hash')";
            ...
            echo '<script>alert("User or email taken"); window.location.href = "../../";</script>';
            exit();
        }
    }
?>
